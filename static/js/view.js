...
var MemberDetail = {
  ...
  onbeforeupdate: function onbeforeupdate(vnode) {
    return vnode.state.member = vnode.attrs.member;
  },
...
var AddMember = {
  ...
  view: function view(vnode) {
    return [['Active', 'Parent', 'Passiv'].includes(vnode.attrs.member.member_type) ? [(0, _mithril.default)('h5', 'Neues Familienmitglied zur Familie hinzufügen'), (0, _mithril.default)('.form-group', [(0, _mithril.default)('input[type=text].form-control.col-12[placeholder=Name]', {
      value: vnode.state.q,
      oninput: function oninput(e) {
...
var eventString = function eventString(event) {
  switch (event.event_type) {
    ...
    case 'Active':
      return 'Statusänderung zu "Aktiv"';

    case 'Passive':
      return 'Statusänderung zu "Passiv"';

    case 'Parent':
      return 'Statusänderung zu "Elternteil"';

    case 'Extern':
      return 'Statusänderung zu "Extern"';
...
var event_types = ['Entry', 'Membership', 'Resignation', 'Trainer', 'CoTrainer', 'Board', 'Honorary', 'Kyu'];
var ClubEventAdd = {
  oninit: function oninit(vnode) {
...
var TrainerEventAdd = {
  ...
  view: function view(vnode) {
    ...
    }, [(0, _mithril.default)('option[value=Promotion]', 'Beförderung'), (0, _mithril.default)('option[value=Demotion]', 'Rücktritt')]), ' Trainer ', (0, _mithril.default)('select.form-control', {
      onchange: function onchange(e) {
...
var HonoraryEventAdd = {
  ...
  view: function view(vnode) {
    return [' weil ', (0, _mithril.default)('input.form-control[type=text][placeholder=Grund]', {
      onchange: function onchange(e) {
        return vnode.state.comment = e.target.value;
      },
      value: vnode.state.comment
...
var MembershipEventAdd = {
  ...
  view: function view(vnode) {
    return [' am ', (0, _mithril.default)('input.form-control[type=text][placeholder=Datum(YYYY-MM-DD)][pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"].', {
      ...
      value: vnode.state.date
    }), ' zu ', (0, _mithril.default)('select.form-control', {
      onchange: function onchange(e) {
        return vnode.state.event_type = e.target.value;
      },
      value: vnode.state.event_type
    }, [(0, _mithril.default)('option[value=Active]', 'Aktiv'), (0, _mithril.default)('option[value=Passive]', 'Passiv'), (0, _mithril.default)('option[value=Parent]', 'Elternteil'), (0, _mithril.default)('option[value=Extern]', 'Extern')]), ' weil ', (0, _mithril.default)('input.form-control[type=text][placeholder=Kommentar]', {
      onchange: function onchange(e) {
        return vnode.state.comment = e.target.value;
      },
      value: vnode.state.comment
...
var MemberEvents = {
  ...
  view: function view(vnode) {
    ...
    return [(0, _mithril.default)('.row', (0, _mithril.default)('.col', [(0, _mithril.default)('h3', 'Verlauf'), (0, _mithril.default)('table.table.table-hover', [(0, _mithril.default)('thead', (0, _mithril.default)('tr', [(0, _mithril.default)('th', 'Was'), (0, _mithril.default)('th', 'Datum'), (0, _mithril.default)('th', 'Kommentar')])), (0, _mithril.default)('tbody', [events.slice(0).reverse().map(function (event) {
    ...
    })])])])), member.id != 0 ? [(0, _mithril.default)('h5', 'Neues Ereignis eintragen'), (0, _mithril.default)('form.form-inline', [(0, _mithril.default)('select.form-control', {
      onchange: function onchange(e) {
      ...
      switch (vnode.state.type) {
        ...
        case 'Membership':
          return (0, _mithril.default)(MembershipEventAdd, {
            transmitter: vnode.state.transmitter,
            member: member
          });
    ...
    tags.forEach(function (tag) {
      ...
      if (tag.Grade) {
        if (tag.Grade.Dan) {
          badges.push({
            type: 'belt-black',
            text: tag.Grade.Dan[1] + '. Dan ' + tag.Grade.Dan[0]
          });
        }

        if (tag.Grade.Kyu) {
          badges.push({
            type: 'belt-' + belt_color(tag.Grade.Kyu[1]),
            text: tag.Grade.Kyu[1] + '. Kyu ' + tag.Grade.Kyu[0]
          });
        }
      }
    }); // PMatriarch
...
var MemberView = {
  ...
  view: function view(vnode) {
    ...
    var family = vnode.state.family;
    var tags = vnode.state.tags;
    var reloader = vnode.state.reloader;
